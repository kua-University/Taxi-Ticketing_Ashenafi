...
// by collecting email and password, and creating a Firebase user account
...
//        data.put(Constants.FSUser.rating, 5.0);
    ...
    private void setRegisterBtnAction() {
        registerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String email = emailEditText.getText().toString().trim();// trim
                ...
                //Call FireStoreAuth for authentication process & creates a new user in firebase authentication
